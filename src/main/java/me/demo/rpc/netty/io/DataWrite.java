 ...
 */
public interface DataWrite extends DataReadWriteConsts {
    /**
     * 返回已写字节数
     */
    ...
    void writeLongDef(Long v, long def) throws IOException;

    void writeByteDef(Byte v, int def) throws IOException;

    void writeShortDef(Short v, int def) throws IOException;

    void writeIntDef(Integer v, int def) throws IOException;

    void writeFloatDef(Float v, float def) throws IOException;

    void writeDoubleDef(Double v, double def) throws IOException;

    void writeBooleanDef(Boolean v, boolean def) throws IOException;

    void writeDateDef(Date v, Date def) throws IOException;
     ...
     *
     * @param v            要写入的字节数组
     * @param isNetByteOrder 长度的2字节是否采用网络字节序
     * @throws IOException 如果发生IO错误
     */
     ...
     *
     * @param v            要写入的字节数组
     * @param isNetByteOrder 长度的4字节是否采用网络字节序
     * @throws IOException 如果发生IO错误
     */
     ...
     * @param v 要写入的字符串
     * @throws IOException 如果发生IO错误
     * @see DataWrite#writePacketShortLen
     */
     ...
     *
     * @param v              要写入的字符串
     * @param isNetByteOrder 包长度是否是网络字节序
     * @throws IOException 如果发生IO错误
     * @see DataWrite#writePacketShortLen
     */
     ...
     * @throws IOException 如果发生IO错误
     */
    void writeByteList(Collection<Byte> ls) throws IOException;
     ...
     * @throws IOException 如果发生IO错误
     */
    void writeShortList(Collection<Short> ls) throws IOException;
     ...
     * @throws IOException 如果发生IO错误
     */
    void writeIntList(Collection<Integer> ls) throws IOException;
     ...
     * @throws IOException 如果发生IO错误
     */
    void writeLongList(Collection<Long> ls) throws IOException;
     ...
     * @throws IOException 如果发生IO错误
     */
    void writeFloatList(Collection<Float> ls) throws IOException;

    /**
     * 写入一个double list
     *
     * @param ls double list
     * @throws IOException 如果发生IO错误
     */
    void writeDoubleList(Collection<Double> ls) throws IOException;
     ...
     * @throws IOException 如果发生IO错误
     */
    <T extends Writable> void writeList(Collection<T> ls) throws IOException;
     ...
     * @throws IOException  如果发生IO错误
     */
    void writePacketByteLenStringList(Collection<String> ls) throws IOException;
     ...
     * @throws IOException  如果发生IO错误
     */
    void writePacketShortLenStringList(Collection<String> ls) throws IOException;
     ...
     * @throws IOException  如果发生IO错误
     */
    void writePacketIntLenStringList(Collection<String> ls) throws IOException;
