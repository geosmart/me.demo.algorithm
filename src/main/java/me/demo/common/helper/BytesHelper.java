...
public class BytesHelper {
     ...
     *
     * @param src     源字节数组
     * @param srcpos  从src的哪个位置开始比较
     * @param dest    目标字节数组
     * @param destpos 从dest的哪个位置开始比较
     * @param len     要比较的长度
     * @return 0 - 两者相等 <br>
     * <0 - src < dest <br>
     * >0 - src > dest
     ...
     *
     * @param b      要转换二进制字节数组
     * @param offset 偏移量,即从字节数组的第几个几字开始转换
     * @return 转换后的浮点数
     */
     ...
     * @return
     */
    public static byte[] slice(byte[] buf, int offset) {
